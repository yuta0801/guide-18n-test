...
::: warning For voice channels this same principle applies to the permission `CONNECT` as well :::
...
::: warning The `ADMINISTRATOR` permission being granted does not skip any hierarchical check! :::
